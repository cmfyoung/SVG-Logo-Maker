...
describe('Circle', () => {
    test('renders', () => {
     ...
     let color = ('orange')
     let bgcolor = ('blue')
      expect(newShape.render()).toEqual(`<svg version="1.1" width="300" height="200" xmlns="http://www.w3.org/2000/svg"><circle cx="150" cy="100" r="100" fill="${this.bgcolor}" /> <text x="150" y="125" font-size="80" text-anchor="middle" fill="${this.color}">${this.initials}</text></svg>`);
    });
});
